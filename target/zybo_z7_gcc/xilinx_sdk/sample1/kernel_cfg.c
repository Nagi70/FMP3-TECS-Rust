...
static STK_T _kernel_stack_TSKID_1_1[COUNT_STK_T(STACK_SIZE)] __attribute__((section(".stack_CLS_ALL_PRC1"),nocommon));
static STK_T _kernel_stack_TSKID_2_1[COUNT_STK_T(STACK_SIZE)] __attribute__((section(".stack_CLS_ALL_PRC2"),nocommon));
static STK_T _kernel_stack_LOGTASK[COUNT_STK_T(LOGTASK_STACK_SIZE)] __attribute__((section(".stack_CLS_PRC1"),nocommon));
const TINIB _kernel_tinib_table[TNUM_TSKID] = {
	{ (TA_ACT), (EXINF)(0), (TASK)(rust_start1), INT_PRIORITY(MID_PRIORITY), ROUND_STK_T(STACK_SIZE), _kernel_stack_TSKID_1_1, 1, 0x3 },
	{ (TA_ACT), (EXINF)(0), (TASK)(rust_start2), INT_PRIORITY(MID_PRIORITY), ROUND_STK_T(STACK_SIZE), _kernel_stack_TSKID_2_1, 2, 0x3 },
	{ (TA_ACT), (EXINF)(0), (TASK)(logtask_main), INT_PRIORITY(LOGTASK_PRIORITY), ROUND_STK_T(LOGTASK_STACK_SIZE), _kernel_stack_LOGTASK, 1, 0x1 }
};

static TCB _kernel_tcb_TSKID_1_1 __attribute__((section(".kernel_data_CLS_ALL_PRC1"),nocommon));
static TCB _kernel_tcb_TSKID_2_1 __attribute__((section(".kernel_data_CLS_ALL_PRC2"),nocommon));
static TCB _kernel_tcb_LOGTASK __attribute__((section(".kernel_data_CLS_PRC1"),nocommon));
...
static SEMCB _kernel_semcb_SERIAL_RCV_SEM1 __attribute__((section(".kernel_data_CLS_PRC1"),nocommon));
static SEMCB _kernel_semcb_SERIAL_SND_SEM1 __attribute__((section(".kernel_data_CLS_PRC1"),nocommon));
...
{
	LOG_ISR_ENTER(ISR_SIO);
	((ISR)(sio_isr))((EXINF)(1));
	LOG_ISR_LEAVE(ISR_SIO);
}
...
const INTINIB _kernel_intinib_table[TNUM_CFG_INTNO] = {
	...
	{ (INTNO_SIO), (INTATR_SIO), (INTPRI_SIO), 1, 0x1U }
};
...
const INIRTNB _kernel_inirtnb_table_global[3] = {
	{ (INIRTN)(syslog_initialize), (EXINF)(0) },
	{ (INIRTN)(print_banner_copyright), (EXINF)(0) },
	{ (INIRTN)(serial_initialize), (EXINF)(0) }
};

const INIRTNB _kernel_inirtnb_table_prc1[2] = {
	{ (INIRTN)(_kernel_target_hrt_initialize), (EXINF)(0) },
	{ (INIRTN)(print_banner), (EXINF)(0) }
};
...
const INIRTNBB _kernel_inirtnbb_table[TNUM_PRCID + 1] = {
	{ 3, _kernel_inirtnb_table_global },
...
const TERRTNB _kernel_terrtnb_table_global[2] = {
	{ (TERRTN)(logtask_terminate), (EXINF)(0) },
	{ (TERRTN)(sio_terminate), (EXINF)(0) }
};

const TERRTNB _kernel_terrtnb_table_prc1[1] = {
...
const TERRTNBB _kernel_terrtnbb_table[TNUM_PRCID + 1] = {
	{ 2, _kernel_terrtnb_table_global },
	{ 1, _kernel_terrtnb_table_prc1 },
