...
const TINIB _kernel_tinib_table[TNUM_TSKID] = {
	...
	{ (TA_ACT), (EXINF)(0), (TASK)(tecs_rust_start_r_processor1_symmetric_task1), INT_PRIORITY(7), ROUND_STK_T(2048), _kernel_stack_TASK1_1, 1, 0x1 },
	{ (TA_ACT), (EXINF)(0), (TASK)(tecs_rust_start_r_processor1_symmetric_task2), INT_PRIORITY(7), ROUND_STK_T(2048), _kernel_stack_TASK1_2, 1, 0x1 },
	{ (TA_ACT), (EXINF)(0), (TASK)(tecs_rust_start_r_processor1_symmetric_task3), INT_PRIORITY(7), ROUND_STK_T(2048), _kernel_stack_TASK1_3, 1, 0x1 },
	{ (TA_ACT), (EXINF)(0), (TASK)(tecs_rust_start_r_processor1_symmetric_task4), INT_PRIORITY(7), ROUND_STK_T(2048), _kernel_stack_TASK1_4, 1, 0x1 },
	{ (TA_ACT), (EXINF)(0), (TASK)(tecs_rust_start_r_processor2_symmetric_task1), INT_PRIORITY(7), ROUND_STK_T(2048), _kernel_stack_TASK2_1, 2, 0x2 },
	{ (TA_ACT), (EXINF)(0), (TASK)(tecs_rust_start_r_processor2_symmetric_task2), INT_PRIORITY(7), ROUND_STK_T(2048), _kernel_stack_TASK2_2, 2, 0x2 },
	{ (TA_ACT), (EXINF)(0), (TASK)(tecs_rust_start_r_processor2_symmetric_task3), INT_PRIORITY(7), ROUND_STK_T(2048), _kernel_stack_TASK2_3, 2, 0x2 }
};
