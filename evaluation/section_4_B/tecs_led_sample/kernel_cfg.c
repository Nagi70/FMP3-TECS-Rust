...
const TINIB _kernel_tinib_table[TNUM_TSKID] = {
	...
	{ (TA_ACT), (EXINF)(0), (TASK)(tecs_rust_start_r_processor1_symmetric_led_task), INT_PRIORITY(7), ROUND_STK_T(2048), _kernel_stack_TSKID_LED, 1, 0x1 },
	{ (TA_ACT), (EXINF)(0), (TASK)(tecs_rust_start_r_processor2_symmetric_loop_task), INT_PRIORITY(7), ROUND_STK_T(2048), _kernel_stack_TSKID_LOOP, 2, 0x2 }
};
...
const ID _kernel_torder_table[TNUM_TSKID] = { 
	TSKID_tTask_rProcessor1Migratable_LogTask_Task, TSKID_LED, TSKID_LOOP
};
