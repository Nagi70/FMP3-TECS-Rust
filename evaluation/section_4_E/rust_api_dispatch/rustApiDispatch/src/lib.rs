...
const c_task :TaskRef = unsafe{TaskRef::from_raw_nonnull(NonZeroI32::new(TSKID_2_2).unwrap())};
const c_taskmig :TaskRef = unsafe{TaskRef::from_raw_nonnull(NonZeroI32::new(TSKID_MIG).unwrap())};
...
pub unsafe extern "C" fn tecs_rust_start_r_processor1_symmetric__task1_1(_: usize) {
    ...
    for i in 0..N{
        ...
        #[cfg(feature = "mig_tsk")]
        {	mig_result = c_taskmig.migrate(processor2);	}
...
#[no_mangle]
pub unsafe extern "C" fn tecs_rust_start_r_processor_all_mig__taskmig(_: usize) {
    unsafe{ 
        END_U = core::ptr::read_volatile(0xF8F00204 as *const u32); // COUNT_U
        END_L  = core::ptr::read_volatile(0xF8F00200 as *const u32); // COUNT_L
    }
...
#[no_mangle]
pub unsafe extern "C" fn tecs_rust_start_r_processor2_symmetric__task2_2(_: usize) {
    unsafe{ 
        END_U = core::ptr::read_volatile(0xF8F00204 as *const u32); // COUNT_U
        END_L  = core::ptr::read_volatile(0xF8F00200 as *const u32); // COUNT_L
    }
