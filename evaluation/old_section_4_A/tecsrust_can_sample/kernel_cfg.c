...
static STK_T _kernel_stack_TSKID_CAN[COUNT_STK_T(2048)] __attribute__((section(".stack_CLS_PRC1"),nocommon));
...
const TINIB _kernel_tinib_table[TNUM_TSKID] = {
	...
	{ (TA_ACT), (EXINF)(0), (TASK)(tecs_rust_start_r_processor1_symmetric__can_task), INT_PRIORITY(7), ROUND_STK_T(2048), _kernel_stack_TSKID_CAN, 1, 0x1 },
	{ (TA_ACT), (EXINF)(0), (TASK)(tecs_rust_start_r_processor2_symmetric__loop_task), INT_PRIORITY(7), ROUND_STK_T(2048), _kernel_stack_TSKID_LOOP, 2, 0x2 }
};
...
static TCB _kernel_tcb_TSKID_CAN __attribute__((section(".kernel_data_CLS_PRC1"),nocommon));
...
TCB	*const _kernel_p_tcb_table[TNUM_TSKID] = {
	...
	&_kernel_tcb_TSKID_CAN,
	&_kernel_tcb_TSKID_LOOP
};

const ID _kernel_torder_table[TNUM_TSKID] = { 
	TSKID_tTask_rProcessor1Migratable_LogTask_Task, TSKID_CAN, TSKID_LOOP
};
