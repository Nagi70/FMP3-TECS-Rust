...
static STK_T _kernel_stack_TASK1_1[COUNT_STK_T(2048)] __attribute__((section(".stack_CLS_PRC1"),nocommon));
static STK_T _kernel_stack_TASK1_2[COUNT_STK_T(2048)] __attribute__((section(".stack_CLS_PRC1"),nocommon));
static STK_T _kernel_stack_TASK1_3[COUNT_STK_T(2048)] __attribute__((section(".stack_CLS_PRC1"),nocommon));
static STK_T _kernel_stack_TASK1_4[COUNT_STK_T(2048)] __attribute__((section(".stack_CLS_PRC1"),nocommon));
static STK_T _kernel_stack_TASK2_1[COUNT_STK_T(2048)] __attribute__((section(".stack_CLS_PRC2"),nocommon));
static STK_T _kernel_stack_TASK2_2[COUNT_STK_T(2048)] __attribute__((section(".stack_CLS_PRC2"),nocommon));
static STK_T _kernel_stack_TASK2_3[COUNT_STK_T(2048)] __attribute__((section(".stack_CLS_PRC2"),nocommon));
const TINIB _kernel_tinib_table[TNUM_TSKID] = {
	...
	{ (TA_ACT), (EXINF)(0), (TASK)(start1), INT_PRIORITY(7), ROUND_STK_T(2048), _kernel_stack_TASK1_1, 1, 0x1 },
	{ (TA_ACT), (EXINF)(0), (TASK)(start2), INT_PRIORITY(7), ROUND_STK_T(2048), _kernel_stack_TASK1_2, 1, 0x1 },
	{ (TA_ACT), (EXINF)(0), (TASK)(start4), INT_PRIORITY(7), ROUND_STK_T(2048), _kernel_stack_TASK1_3, 1, 0x1 },
	{ (TA_ACT), (EXINF)(0), (TASK)(start6), INT_PRIORITY(7), ROUND_STK_T(2048), _kernel_stack_TASK1_4, 1, 0x1 },
	{ (TA_ACT), (EXINF)(0), (TASK)(start1), INT_PRIORITY(7), ROUND_STK_T(2048), _kernel_stack_TASK2_1, 2, 0x2 },
	{ (TA_ACT), (EXINF)(0), (TASK)(start3), INT_PRIORITY(7), ROUND_STK_T(2048), _kernel_stack_TASK2_2, 2, 0x2 },
	{ (TA_ACT), (EXINF)(0), (TASK)(start5), INT_PRIORITY(7), ROUND_STK_T(2048), _kernel_stack_TASK2_3, 2, 0x2 }
};
...
static TCB _kernel_tcb_TASK1_1 __attribute__((section(".kernel_data_CLS_PRC1"),nocommon));
static TCB _kernel_tcb_TASK1_2 __attribute__((section(".kernel_data_CLS_PRC1"),nocommon));
static TCB _kernel_tcb_TASK1_3 __attribute__((section(".kernel_data_CLS_PRC1"),nocommon));
static TCB _kernel_tcb_TASK1_4 __attribute__((section(".kernel_data_CLS_PRC1"),nocommon));
static TCB _kernel_tcb_TASK2_1 __attribute__((section(".kernel_data_CLS_PRC2"),nocommon));
static TCB _kernel_tcb_TASK2_2 __attribute__((section(".kernel_data_CLS_PRC2"),nocommon));
static TCB _kernel_tcb_TASK2_3 __attribute__((section(".kernel_data_CLS_PRC2"),nocommon));
...
const ID _kernel_torder_table[TNUM_TSKID] = { 
	TSKID_tTask_rProcessor1Migratable_LogTask_Task, TASK1_1, TASK1_2, TASK1_3, TASK1_4, TASK2_1, TASK2_2, TASK2_3
};
...
static SEMCB _kernel_semcb_TECS_RUST_EX_CTRL_2 __attribute__((section(".kernel_data_CLS_ALL_PRC1"),nocommon));
static SEMCB _kernel_semcb_TECS_RUST_EX_CTRL_3 __attribute__((section(".kernel_data_CLS_ALL_PRC1"),nocommon));
static SEMCB _kernel_semcb_TECS_RUST_EX_CTRL_4 __attribute__((section(".kernel_data_CLS_ALL_PRC1"),nocommon));
static SEMCB _kernel_semcb_TECS_RUST_EX_CTRL_5 __attribute__((section(".kernel_data_CLS_ALL_PRC1"),nocommon));
static SEMCB _kernel_semcb_TECS_RUST_EX_CTRL_6 __attribute__((section(".kernel_data_CLS_ALL_PRC1"),nocommon));
...
SEMCB	*const _kernel_p_semcb_table[TNUM_SEMID] = {
	...
	&_kernel_semcb_TECS_RUST_EX_CTRL_2,
	&_kernel_semcb_TECS_RUST_EX_CTRL_3,
	&_kernel_semcb_TECS_RUST_EX_CTRL_4,
	&_kernel_semcb_TECS_RUST_EX_CTRL_5,
	&_kernel_semcb_TECS_RUST_EX_CTRL_6
};
...
const INIRTNB _kernel_inirtnb_table_prc1[1] = {
