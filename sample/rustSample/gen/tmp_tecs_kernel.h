...
/*  1 "../../tecs_kernel/tecs_kernel.h" 1 */
/*  47 "../../tecs_kernel/tecs_kernel.h" */
...
/*  71 "../../target/zybo_z7_gcc/target_kernel.h" 2 */
...
/*  212 "../../include/kernel.h" */
extern ER act_tsk(ID tskid) ;
extern ER mact_tsk(ID tskid, ID prcid) ;
extern ER_UINT can_act(ID tskid) ;
extern ER mig_tsk(ID tskid, ID prcid) ;
...
extern ER chg_spr(ID tskid, uint_t subpri) ;
...
extern ER loc_spn(ID spnid) ;
extern ER unl_spn(ID spnid) ;
extern ER try_spn(ID spnid) ;
extern ER ref_spn(ID spnid, T_RSPN *pk_rspn) ;
...
extern ER mrot_rdq(PRI tskpri, ID prcid) ;
extern ER get_tid(ID *p_tskid) ;
extern ER get_pid(ID *p_prcid) ;
extern ER get_lod(PRI tskpri, uint_t *p_load) ;
extern ER mget_lod(ID schedid, PRI tskpri, uint_t *p_load) ;
extern ER get_nth(PRI tskpri, uint_t nth, ID *p_tskid) ;
extern ER mget_nth(ID schedid, PRI tskpri, uint_t nth, ID *p_tskid) ;
...
/*  48 "../../tecs_kernel/tecs_kernel.h" 2 */
