            ...
            fn from_native(#[allow(unused)] msg: &Self::CStruct) -> Request {
                Request {
                    projected_maps_info: {
                        ...
                        if msg.projected_maps_info.data != std::ptr::null_mut() {
                            let slice = unsafe {
...
pub mod msg {
    ...
    impl PointCloud2Update {
        pub const ADD: _bindgen_ty_67 = map_msgs__msg__PointCloud2Update__ADD;
        pub const DELETE: _bindgen_ty_68 = map_msgs__msg__PointCloud2Update__DELETE;
    }
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(default)]
