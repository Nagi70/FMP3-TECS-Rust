    ...
    pub mod ConfigLogger {
        ...
        impl WrappedTypesupport for Request {
            ...
            fn get_ts() -> &'static rosidl_message_type_support_t {
                unsafe {
                    &*rosidl_typesupport_c__get_message_type_support_handle__logging_demo__srv__ConfigLogger_Request()
                }
            }
            ...
            fn destroy_msg(msg: *mut logging_demo__srv__ConfigLogger_Request) -> () {
                ...
                #[cfg(feature = "doc-only")]
                logging_demo__srv__ConfigLogger_Request__destroy(msg)
            }
            ...
            fn copy_to_native(&self, #[allow(unused)] msg: &mut Self::CStruct) {
                msg.logger_name.assign(&self.logger_name);
        ...
        impl WrappedTypesupport for Response {
            ...
            fn get_ts() -> &'static rosidl_message_type_support_t {
                unsafe {
                    &*rosidl_typesupport_c__get_message_type_support_handle__logging_demo__srv__ConfigLogger_Response()
                }
            }
            ...
            fn destroy_msg(msg: *mut logging_demo__srv__ConfigLogger_Response) -> () {
                ...
                #[cfg(feature = "doc-only")]
                logging_demo__srv__ConfigLogger_Response__destroy(msg)
            }
