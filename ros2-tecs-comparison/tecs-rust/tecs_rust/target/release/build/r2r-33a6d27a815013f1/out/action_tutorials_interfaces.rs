    ...
    pub mod Fibonacci {
        ...
        impl WrappedTypesupport for Goal {
            ...
            fn get_ts() -> &'static rosidl_message_type_support_t {
                unsafe {
                    &*rosidl_typesupport_c__get_message_type_support_handle__action_tutorials_interfaces__action__Fibonacci_Goal()
                }
            }
            ...
            fn destroy_msg(
                msg: *mut action_tutorials_interfaces__action__Fibonacci_Goal,
            ) -> () {
                #[cfg(not(feature = "doc-only"))]
                unsafe {
                    action_tutorials_interfaces__action__Fibonacci_Goal__destroy(msg)
                };
                #[cfg(feature = "doc-only")]
                action_tutorials_interfaces__action__Fibonacci_Goal__destroy(msg)
            }
        ...
        impl WrappedTypesupport for Result {
            ...
            fn get_ts() -> &'static rosidl_message_type_support_t {
                unsafe {
                    &*rosidl_typesupport_c__get_message_type_support_handle__action_tutorials_interfaces__action__Fibonacci_Result()
                }
            }
            ...
            fn destroy_msg(
                msg: *mut action_tutorials_interfaces__action__Fibonacci_Result,
            ) -> () {
                #[cfg(not(feature = "doc-only"))]
                unsafe {
                    action_tutorials_interfaces__action__Fibonacci_Result__destroy(msg)
                };
                #[cfg(feature = "doc-only")]
                action_tutorials_interfaces__action__Fibonacci_Result__destroy(msg)
            }
        ...
        impl WrappedTypesupport for Feedback {
            ...
            fn get_ts() -> &'static rosidl_message_type_support_t {
                unsafe {
                    &*rosidl_typesupport_c__get_message_type_support_handle__action_tutorials_interfaces__action__Fibonacci_Feedback()
                }
            }
            ...
            fn destroy_msg(
                msg: *mut action_tutorials_interfaces__action__Fibonacci_Feedback,
            ) -> () {
                #[cfg(not(feature = "doc-only"))]
                unsafe {
                    action_tutorials_interfaces__action__Fibonacci_Feedback__destroy(msg)
                };
                #[cfg(feature = "doc-only")]
                action_tutorials_interfaces__action__Fibonacci_Feedback__destroy(msg)
            }
            ...
            fn copy_to_native(&self, #[allow(unused)] msg: &mut Self::CStruct) {
                msg.partial_sequence.update(&self.partial_sequence);
            }
        }
        ...
        pub mod SendGoal {
            ...
            impl WrappedTypesupport for Request {
                ...
                fn get_ts() -> &'static rosidl_message_type_support_t {
                    unsafe {
                        &*rosidl_typesupport_c__get_message_type_support_handle__action_tutorials_interfaces__action__Fibonacci_SendGoal_Request()
                    }
                }
                ...
                fn destroy_msg(
                    msg: *mut action_tutorials_interfaces__action__Fibonacci_SendGoal_Request,
                ) -> () {
                    #[cfg(not(feature = "doc-only"))]
                    unsafe {
                        action_tutorials_interfaces__action__Fibonacci_SendGoal_Request__destroy(
                            msg,
                        )
                    };
                    #[cfg(feature = "doc-only")]
                ...
                fn from_native(#[allow(unused)] msg: &Self::CStruct) -> Request {
                    Request {
                        ...
                        goal: action_tutorials_interfaces::action::Fibonacci::Goal::from_native(
                            &msg.goal,
                        ),
                    }
                }
            ...
            impl WrappedTypesupport for Response {
                ...
                fn get_ts() -> &'static rosidl_message_type_support_t {
                    unsafe {
                        &*rosidl_typesupport_c__get_message_type_support_handle__action_tutorials_interfaces__action__Fibonacci_SendGoal_Response()
                    }
                }
                ...
                fn destroy_msg(
                    msg: *mut action_tutorials_interfaces__action__Fibonacci_SendGoal_Response,
                ) -> () {
                    #[cfg(not(feature = "doc-only"))]
                    unsafe {
                        action_tutorials_interfaces__action__Fibonacci_SendGoal_Response__destroy(
                            msg,
                        )
                    };
                    #[cfg(feature = "doc-only")]
        ...
        pub mod GetResult {
            ...
            impl WrappedTypesupport for Request {
                ...
                fn get_ts() -> &'static rosidl_message_type_support_t {
                    unsafe {
                        &*rosidl_typesupport_c__get_message_type_support_handle__action_tutorials_interfaces__action__Fibonacci_GetResult_Request()
                    }
                }
                ...
                fn destroy_msg(
                    msg: *mut action_tutorials_interfaces__action__Fibonacci_GetResult_Request,
                ) -> () {
                    #[cfg(not(feature = "doc-only"))]
                    unsafe {
                        action_tutorials_interfaces__action__Fibonacci_GetResult_Request__destroy(
                            msg,
                        )
                    };
                    #[cfg(feature = "doc-only")]
            ...
            impl WrappedTypesupport for Response {
                ...
                fn get_ts() -> &'static rosidl_message_type_support_t {
                    unsafe {
                        &*rosidl_typesupport_c__get_message_type_support_handle__action_tutorials_interfaces__action__Fibonacci_GetResult_Response()
                    }
                }
                ...
                fn destroy_msg(
                    msg: *mut action_tutorials_interfaces__action__Fibonacci_GetResult_Response,
                ) -> () {
                    #[cfg(not(feature = "doc-only"))]
                    unsafe {
                        action_tutorials_interfaces__action__Fibonacci_GetResult_Response__destroy(
                            msg,
                        )
                    };
                    #[cfg(feature = "doc-only")]
                ...
                fn from_native(#[allow(unused)] msg: &Self::CStruct) -> Response {
                    Response {
                        status: msg.status,
                        result: action_tutorials_interfaces::action::Fibonacci::Result::from_native(
                            &msg.result,
                        ),
                    }
                }
        ...
        impl WrappedTypesupport for FeedbackMessage {
            ...
            fn get_ts() -> &'static rosidl_message_type_support_t {
                unsafe {
                    &*rosidl_typesupport_c__get_message_type_support_handle__action_tutorials_interfaces__action__Fibonacci_FeedbackMessage()
                }
            }
            ...
            fn destroy_msg(
                msg: *mut action_tutorials_interfaces__action__Fibonacci_FeedbackMessage,
            ) -> () {
                #[cfg(not(feature = "doc-only"))]
                unsafe {
                    action_tutorials_interfaces__action__Fibonacci_FeedbackMessage__destroy(
                        msg,
                    )
                };
                #[cfg(feature = "doc-only")]
            ...
            fn from_native(#[allow(unused)] msg: &Self::CStruct) -> FeedbackMessage {
                FeedbackMessage {
                    ...
                    feedback: action_tutorials_interfaces::action::Fibonacci::Feedback::from_native(
                        &msg.feedback,
                    ),
                }
            }
