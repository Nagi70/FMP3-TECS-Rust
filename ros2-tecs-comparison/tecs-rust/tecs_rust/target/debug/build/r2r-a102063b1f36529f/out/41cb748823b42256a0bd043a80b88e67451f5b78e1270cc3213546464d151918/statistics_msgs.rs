pub mod msg {
        ...
        fn from_native(#[allow(unused)] msg: &Self::CStruct) -> MetricsMessage {
            MetricsMessage {
                ...
                statistics: {
                    ...
                    if msg.statistics.data != std::ptr::null_mut() {
                        let slice = unsafe {
    ...
    impl StatisticDataType {
        pub const STATISTICS_DATA_TYPE_AVERAGE: _bindgen_ty_156 = statistics_msgs__msg__StatisticDataType__STATISTICS_DATA_TYPE_AVERAGE;
        pub const STATISTICS_DATA_TYPE_MAXIMUM: _bindgen_ty_158 = statistics_msgs__msg__StatisticDataType__STATISTICS_DATA_TYPE_MAXIMUM;
        pub const STATISTICS_DATA_TYPE_MINIMUM: _bindgen_ty_157 = statistics_msgs__msg__StatisticDataType__STATISTICS_DATA_TYPE_MINIMUM;
        pub const STATISTICS_DATA_TYPE_SAMPLE_COUNT: _bindgen_ty_160 = statistics_msgs__msg__StatisticDataType__STATISTICS_DATA_TYPE_SAMPLE_COUNT;
        pub const STATISTICS_DATA_TYPE_STDDEV: _bindgen_ty_159 = statistics_msgs__msg__StatisticDataType__STATISTICS_DATA_TYPE_STDDEV;
        pub const STATISTICS_DATA_TYPE_UNINITIALIZED: _bindgen_ty_155 = statistics_msgs__msg__StatisticDataType__STATISTICS_DATA_TYPE_UNINITIALIZED;
    }
}
