pub mod msg {
        ...
        fn from_native(#[allow(unused)] msg: &Self::CStruct) -> Mesh {
            Mesh {
                triangles: {
                    ...
                    if msg.triangles.data != std::ptr::null_mut() {
                        let slice = unsafe {
                ...
                vertices: {
                    ...
                    if msg.vertices.data != std::ptr::null_mut() {
                        let slice = unsafe {
                            std::slice::from_raw_parts(
                                msg.vertices.data,
                                msg.vertices.size,
    ...
    impl SolidPrimitive {
        pub const BOX: _bindgen_ty_140 = shape_msgs__msg__SolidPrimitive__BOX;
        pub const BOX_X: _bindgen_ty_145 = shape_msgs__msg__SolidPrimitive__BOX_X;
        pub const BOX_Y: _bindgen_ty_146 = shape_msgs__msg__SolidPrimitive__BOX_Y;
        pub const BOX_Z: _bindgen_ty_147 = shape_msgs__msg__SolidPrimitive__BOX_Z;
        pub const CONE: _bindgen_ty_143 = shape_msgs__msg__SolidPrimitive__CONE;
        pub const CONE_HEIGHT: _bindgen_ty_151 = shape_msgs__msg__SolidPrimitive__CONE_HEIGHT;
        pub const CONE_RADIUS: _bindgen_ty_152 = shape_msgs__msg__SolidPrimitive__CONE_RADIUS;
        pub const CYLINDER: _bindgen_ty_142 = shape_msgs__msg__SolidPrimitive__CYLINDER;
        pub const CYLINDER_HEIGHT: _bindgen_ty_149 = shape_msgs__msg__SolidPrimitive__CYLINDER_HEIGHT;
        pub const CYLINDER_RADIUS: _bindgen_ty_150 = shape_msgs__msg__SolidPrimitive__CYLINDER_RADIUS;
        pub const PRISM: _bindgen_ty_144 = shape_msgs__msg__SolidPrimitive__PRISM;
        pub const PRISM_HEIGHT: _bindgen_ty_153 = shape_msgs__msg__SolidPrimitive__PRISM_HEIGHT;
        pub const SPHERE: _bindgen_ty_141 = shape_msgs__msg__SolidPrimitive__SPHERE;
        pub const SPHERE_RADIUS: _bindgen_ty_148 = shape_msgs__msg__SolidPrimitive__SPHERE_RADIUS;
    }
}
