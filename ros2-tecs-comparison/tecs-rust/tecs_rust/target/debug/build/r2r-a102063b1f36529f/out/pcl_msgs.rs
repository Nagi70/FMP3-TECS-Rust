    ...
    pub mod UpdateFilename {
        ...
        impl WrappedTypesupport for Request {
            ...
            fn get_ts() -> &'static rosidl_message_type_support_t {
                unsafe {
                    &*rosidl_typesupport_c__get_message_type_support_handle__pcl_msgs__srv__UpdateFilename_Request()
                }
            }
            ...
            fn destroy_msg(msg: *mut pcl_msgs__srv__UpdateFilename_Request) -> () {
                ...
                #[cfg(feature = "doc-only")]
                pcl_msgs__srv__UpdateFilename_Request__destroy(msg)
            }
        ...
        impl WrappedTypesupport for Response {
            ...
            fn get_ts() -> &'static rosidl_message_type_support_t {
                unsafe {
                    &*rosidl_typesupport_c__get_message_type_support_handle__pcl_msgs__srv__UpdateFilename_Response()
                }
            }
            ...
            fn destroy_msg(msg: *mut pcl_msgs__srv__UpdateFilename_Response) -> () {
                ...
                #[cfg(feature = "doc-only")]
                pcl_msgs__srv__UpdateFilename_Response__destroy(msg)
            }
...
pub mod msg {
    ...
    impl WrappedTypesupport for ModelCoefficients {
        ...
        fn get_ts() -> &'static rosidl_message_type_support_t {
            unsafe {
                &*rosidl_typesupport_c__get_message_type_support_handle__pcl_msgs__msg__ModelCoefficients()
            }
        }
        fn create_msg() -> *mut pcl_msgs__msg__ModelCoefficients {
            #[cfg(not(feature = "doc-only"))]
            unsafe { pcl_msgs__msg__ModelCoefficients__create() }
            #[cfg(feature = "doc-only")] pcl_msgs__msg__ModelCoefficients__create()
        }
        fn destroy_msg(msg: *mut pcl_msgs__msg__ModelCoefficients) -> () {
            #[cfg(not(feature = "doc-only"))]
            unsafe { pcl_msgs__msg__ModelCoefficients__destroy(msg) };
            #[cfg(feature = "doc-only")] pcl_msgs__msg__ModelCoefficients__destroy(msg)
        }
        fn from_native(#[allow(unused)] msg: &Self::CStruct) -> ModelCoefficients {
            ModelCoefficients {
    ...
    impl WrappedTypesupport for PointIndices {
        ...
        fn get_ts() -> &'static rosidl_message_type_support_t {
            unsafe {
                &*rosidl_typesupport_c__get_message_type_support_handle__pcl_msgs__msg__PointIndices()
            }
        }
        fn create_msg() -> *mut pcl_msgs__msg__PointIndices {
            #[cfg(not(feature = "doc-only"))]
            unsafe { pcl_msgs__msg__PointIndices__create() }
            #[cfg(feature = "doc-only")] pcl_msgs__msg__PointIndices__create()
        }
        fn destroy_msg(msg: *mut pcl_msgs__msg__PointIndices) -> () {
            #[cfg(not(feature = "doc-only"))]
            unsafe { pcl_msgs__msg__PointIndices__destroy(msg) };
            #[cfg(feature = "doc-only")] pcl_msgs__msg__PointIndices__destroy(msg)
        }
        fn from_native(#[allow(unused)] msg: &Self::CStruct) -> PointIndices {
            PointIndices {
                header: std_msgs::msg::Header::from_native(&msg.header),
    ...
    impl WrappedTypesupport for PolygonMesh {
        ...
        fn get_ts() -> &'static rosidl_message_type_support_t {
            unsafe {
                &*rosidl_typesupport_c__get_message_type_support_handle__pcl_msgs__msg__PolygonMesh()
            }
        }
        fn create_msg() -> *mut pcl_msgs__msg__PolygonMesh {
            #[cfg(not(feature = "doc-only"))]
            unsafe { pcl_msgs__msg__PolygonMesh__create() }
            #[cfg(feature = "doc-only")] pcl_msgs__msg__PolygonMesh__create()
        }
        fn destroy_msg(msg: *mut pcl_msgs__msg__PolygonMesh) -> () {
            #[cfg(not(feature = "doc-only"))]
            unsafe { pcl_msgs__msg__PolygonMesh__destroy(msg) };
            #[cfg(feature = "doc-only")] pcl_msgs__msg__PolygonMesh__destroy(msg)
        }
        fn from_native(#[allow(unused)] msg: &Self::CStruct) -> PolygonMesh {
            PolygonMesh {
                header: std_msgs::msg::Header::from_native(&msg.header),
                cloud: sensor_msgs::msg::PointCloud2::from_native(&msg.cloud),
                polygons: {
                    let mut temp = Vec::with_capacity(msg.polygons.size);
                    if msg.polygons.data != std::ptr::null_mut() {
                        let slice = unsafe {
                        ...
                        for s in slice {
                            temp.push(pcl_msgs::msg::Vertices::from_native(s));
                        }
                    }
                    temp
                },
        ...
        fn copy_to_native(&self, #[allow(unused)] msg: &mut Self::CStruct) {
            ...
            unsafe {
                pcl_msgs__msg__Vertices__Sequence__fini(&mut msg.polygons);
                ...
                if msg.polygons.data != std::ptr::null_mut() {
                    ...
                    for (t, s) in slice.iter_mut().zip(&self.polygons) {
                        s.copy_to_native(t);
                    }
                }
            }
    ...
    impl WrappedTypesupport for Vertices {
        ...
        fn get_ts() -> &'static rosidl_message_type_support_t {
            unsafe {
                &*rosidl_typesupport_c__get_message_type_support_handle__pcl_msgs__msg__Vertices()
            }
        }
        fn create_msg() -> *mut pcl_msgs__msg__Vertices {
            #[cfg(not(feature = "doc-only"))]
            unsafe { pcl_msgs__msg__Vertices__create() }
            #[cfg(feature = "doc-only")] pcl_msgs__msg__Vertices__create()
        }
        fn destroy_msg(msg: *mut pcl_msgs__msg__Vertices) -> () {
            #[cfg(not(feature = "doc-only"))]
            unsafe { pcl_msgs__msg__Vertices__destroy(msg) };
            #[cfg(feature = "doc-only")] pcl_msgs__msg__Vertices__destroy(msg)
        }
        fn from_native(#[allow(unused)] msg: &Self::CStruct) -> Vertices {
            Vertices {
                vertices: msg.vertices.to_vec(),
            }
        }
        fn copy_to_native(&self, #[allow(unused)] msg: &mut Self::CStruct) {
            msg.vertices.update(&self.vertices);
        }
    }
