        ...
        fn from_native(#[allow(unused)] msg: &Self::CStruct) -> GridCells {
            GridCells {
                ...
                cells: {
                    ...
                    if msg.cells.data != std::ptr::null_mut() {
                        let slice = unsafe {
...
pub mod srv {
    ...
    pub mod LoadMap {
        ...
        impl Response {
            pub const RESULT_INVALID_MAP_DATA: _bindgen_ty_79 = nav_msgs__srv__LoadMap_Response__RESULT_INVALID_MAP_DATA;
            pub const RESULT_INVALID_MAP_METADATA: _bindgen_ty_80 = nav_msgs__srv__LoadMap_Response__RESULT_INVALID_MAP_METADATA;
            pub const RESULT_MAP_DOES_NOT_EXIST: _bindgen_ty_78 = nav_msgs__srv__LoadMap_Response__RESULT_MAP_DOES_NOT_EXIST;
            pub const RESULT_SUCCESS: _bindgen_ty_77 = nav_msgs__srv__LoadMap_Response__RESULT_SUCCESS;
            pub const RESULT_UNDEFINED_FAILURE: _bindgen_ty_81 = nav_msgs__srv__LoadMap_Response__RESULT_UNDEFINED_FAILURE;
        }
    }
    #[allow(non_snake_case)]
    pub mod SetMap {
