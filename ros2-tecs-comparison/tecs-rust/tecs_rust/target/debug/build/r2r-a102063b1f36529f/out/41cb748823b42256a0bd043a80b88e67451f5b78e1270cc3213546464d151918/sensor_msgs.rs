pub mod msg {
    ...
    impl BatteryState {
        pub const POWER_SUPPLY_HEALTH_COLD: _bindgen_ty_113 = sensor_msgs__msg__BatteryState__POWER_SUPPLY_HEALTH_COLD;
        pub const POWER_SUPPLY_HEALTH_DEAD: _bindgen_ty_110 = sensor_msgs__msg__BatteryState__POWER_SUPPLY_HEALTH_DEAD;
        pub const POWER_SUPPLY_HEALTH_GOOD: _bindgen_ty_108 = sensor_msgs__msg__BatteryState__POWER_SUPPLY_HEALTH_GOOD;
        pub const POWER_SUPPLY_HEALTH_OVERHEAT: _bindgen_ty_109 = sensor_msgs__msg__BatteryState__POWER_SUPPLY_HEALTH_OVERHEAT;
        pub const POWER_SUPPLY_HEALTH_OVERVOLTAGE: _bindgen_ty_111 = sensor_msgs__msg__BatteryState__POWER_SUPPLY_HEALTH_OVERVOLTAGE;
        pub const POWER_SUPPLY_HEALTH_SAFETY_TIMER_EXPIRE: _bindgen_ty_115 = sensor_msgs__msg__BatteryState__POWER_SUPPLY_HEALTH_SAFETY_TIMER_EXPIRE;
        pub const POWER_SUPPLY_HEALTH_UNKNOWN: _bindgen_ty_107 = sensor_msgs__msg__BatteryState__POWER_SUPPLY_HEALTH_UNKNOWN;
        pub const POWER_SUPPLY_HEALTH_UNSPEC_FAILURE: _bindgen_ty_112 = sensor_msgs__msg__BatteryState__POWER_SUPPLY_HEALTH_UNSPEC_FAILURE;
        pub const POWER_SUPPLY_HEALTH_WATCHDOG_TIMER_EXPIRE: _bindgen_ty_114 = sensor_msgs__msg__BatteryState__POWER_SUPPLY_HEALTH_WATCHDOG_TIMER_EXPIRE;
        pub const POWER_SUPPLY_STATUS_CHARGING: _bindgen_ty_103 = sensor_msgs__msg__BatteryState__POWER_SUPPLY_STATUS_CHARGING;
        pub const POWER_SUPPLY_STATUS_DISCHARGING: _bindgen_ty_104 = sensor_msgs__msg__BatteryState__POWER_SUPPLY_STATUS_DISCHARGING;
        pub const POWER_SUPPLY_STATUS_FULL: _bindgen_ty_106 = sensor_msgs__msg__BatteryState__POWER_SUPPLY_STATUS_FULL;
        pub const POWER_SUPPLY_STATUS_NOT_CHARGING: _bindgen_ty_105 = sensor_msgs__msg__BatteryState__POWER_SUPPLY_STATUS_NOT_CHARGING;
        pub const POWER_SUPPLY_STATUS_UNKNOWN: _bindgen_ty_102 = sensor_msgs__msg__BatteryState__POWER_SUPPLY_STATUS_UNKNOWN;
        pub const POWER_SUPPLY_TECHNOLOGY_LIFE: _bindgen_ty_120 = sensor_msgs__msg__BatteryState__POWER_SUPPLY_TECHNOLOGY_LIFE;
        pub const POWER_SUPPLY_TECHNOLOGY_LIMN: _bindgen_ty_122 = sensor_msgs__msg__BatteryState__POWER_SUPPLY_TECHNOLOGY_LIMN;
        pub const POWER_SUPPLY_TECHNOLOGY_LION: _bindgen_ty_118 = sensor_msgs__msg__BatteryState__POWER_SUPPLY_TECHNOLOGY_LION;
        pub const POWER_SUPPLY_TECHNOLOGY_LIPO: _bindgen_ty_119 = sensor_msgs__msg__BatteryState__POWER_SUPPLY_TECHNOLOGY_LIPO;
        pub const POWER_SUPPLY_TECHNOLOGY_NICD: _bindgen_ty_121 = sensor_msgs__msg__BatteryState__POWER_SUPPLY_TECHNOLOGY_NICD;
        pub const POWER_SUPPLY_TECHNOLOGY_NIMH: _bindgen_ty_117 = sensor_msgs__msg__BatteryState__POWER_SUPPLY_TECHNOLOGY_NIMH;
        pub const POWER_SUPPLY_TECHNOLOGY_UNKNOWN: _bindgen_ty_116 = sensor_msgs__msg__BatteryState__POWER_SUPPLY_TECHNOLOGY_UNKNOWN;
    }
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(default)]
    ...
    impl WrappedTypesupport for Imu {
        ...
        fn copy_to_native(&self, #[allow(unused)] msg: &mut Self::CStruct) {
            ...
            assert_eq!(
                self.orientation_covariance.len(),
                9usize,
                "Field {} is fixed size of {}!",
            ...
            assert_eq!(
                self.angular_velocity_covariance.len(),
                9usize,
                "Field {} is fixed size of {}!",
            ...
            assert_eq!(
                self.linear_acceleration_covariance.len(),
                9usize,
                "Field {} is fixed size of {}!",
                "linear_acceleration_covariance",
                9usize,
    ...
    #[allow(non_upper_case_globals)]
    impl JoyFeedback {
        pub const TYPE_BUZZER: _bindgen_ty_125 = sensor_msgs__msg__JoyFeedback__TYPE_BUZZER;
        pub const TYPE_LED: _bindgen_ty_123 = sensor_msgs__msg__JoyFeedback__TYPE_LED;
        pub const TYPE_RUMBLE: _bindgen_ty_124 = sensor_msgs__msg__JoyFeedback__TYPE_RUMBLE;
    }
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(default)]
        ...
        fn from_native(#[allow(unused)] msg: &Self::CStruct) -> JoyFeedbackArray {
            JoyFeedbackArray {
                array: {
                    ...
                    if msg.array.data != std::ptr::null_mut() {
                        let slice = unsafe {
    ...
    impl WrappedTypesupport for MagneticField {
        ...
        fn copy_to_native(&self, #[allow(unused)] msg: &mut Self::CStruct) {
            ...
            assert_eq!(
                self.magnetic_field_covariance.len(),
                9usize,
                "Field {} is fixed size of {}!",
        ...
        fn from_native(#[allow(unused)] msg: &Self::CStruct) -> MultiDOFJointState {
            MultiDOFJointState {
                ...
                transforms: {
                    ...
                    if msg.transforms.data != std::ptr::null_mut() {
                        let slice = unsafe {
                ...
                twist: {
                    ...
                    if msg.twist.data != std::ptr::null_mut() {
                        let slice = unsafe {
                ...
                wrench: {
                    ...
                    if msg.wrench.data != std::ptr::null_mut() {
                        let slice = unsafe {
        ...
        fn from_native(#[allow(unused)] msg: &Self::CStruct) -> MultiEchoLaserScan {
            MultiEchoLaserScan {
                ...
                ranges: {
                    ...
                    if msg.ranges.data != std::ptr::null_mut() {
                        let slice = unsafe {
                ...
                intensities: {
                    ...
                    if msg.intensities.data != std::ptr::null_mut() {
                        let slice = unsafe {
                            std::slice::from_raw_parts(
    ...
    #[allow(non_upper_case_globals)]
    impl NavSatFix {
        pub const COVARIANCE_TYPE_APPROXIMATED: _bindgen_ty_127 = sensor_msgs__msg__NavSatFix__COVARIANCE_TYPE_APPROXIMATED;
        pub const COVARIANCE_TYPE_DIAGONAL_KNOWN: _bindgen_ty_128 = sensor_msgs__msg__NavSatFix__COVARIANCE_TYPE_DIAGONAL_KNOWN;
        pub const COVARIANCE_TYPE_KNOWN: _bindgen_ty_129 = sensor_msgs__msg__NavSatFix__COVARIANCE_TYPE_KNOWN;
        pub const COVARIANCE_TYPE_UNKNOWN: _bindgen_ty_126 = sensor_msgs__msg__NavSatFix__COVARIANCE_TYPE_UNKNOWN;
    }
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(default)]
    ...
    #[allow(non_upper_case_globals)]
    impl NavSatStatus {
        pub const SERVICE_COMPASS: _bindgen_ty_136 = sensor_msgs__msg__NavSatStatus__SERVICE_COMPASS;
        pub const SERVICE_GALILEO: _bindgen_ty_137 = sensor_msgs__msg__NavSatStatus__SERVICE_GALILEO;
        pub const SERVICE_GLONASS: _bindgen_ty_135 = sensor_msgs__msg__NavSatStatus__SERVICE_GLONASS;
        pub const SERVICE_GPS: _bindgen_ty_134 = sensor_msgs__msg__NavSatStatus__SERVICE_GPS;
        pub const STATUS_FIX: _bindgen_ty_131 = sensor_msgs__msg__NavSatStatus__STATUS_FIX;
        pub const STATUS_GBAS_FIX: _bindgen_ty_133 = sensor_msgs__msg__NavSatStatus__STATUS_GBAS_FIX;
        pub const STATUS_NO_FIX: _bindgen_ty_130 = sensor_msgs__msg__NavSatStatus__STATUS_NO_FIX;
        pub const STATUS_SBAS_FIX: _bindgen_ty_132 = sensor_msgs__msg__NavSatStatus__STATUS_SBAS_FIX;
    }
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(default)]
        ...
        fn from_native(#[allow(unused)] msg: &Self::CStruct) -> PointCloud {
            PointCloud {
                ...
                points: {
                    ...
                    if msg.points.data != std::ptr::null_mut() {
                        let slice = unsafe {
                ...
                channels: {
                    ...
                    if msg.channels.data != std::ptr::null_mut() {
                        let slice = unsafe {
                            std::slice::from_raw_parts(
                                msg.channels.data,
                                msg.channels.size,
        ...
        fn from_native(#[allow(unused)] msg: &Self::CStruct) -> PointCloud2 {
            PointCloud2 {
                ...
                fields: {
                    ...
                    if msg.fields.data != std::ptr::null_mut() {
                        let slice = unsafe {
    ...
    #[allow(non_upper_case_globals)]
    impl PointField {
        pub const FLOAT32: _bindgen_ty_75 = sensor_msgs__msg__PointField__FLOAT32;
        pub const FLOAT64: _bindgen_ty_76 = sensor_msgs__msg__PointField__FLOAT64;
        pub const INT16: _bindgen_ty_71 = sensor_msgs__msg__PointField__INT16;
        pub const INT32: _bindgen_ty_73 = sensor_msgs__msg__PointField__INT32;
        pub const INT8: _bindgen_ty_69 = sensor_msgs__msg__PointField__INT8;
        pub const UINT16: _bindgen_ty_72 = sensor_msgs__msg__PointField__UINT16;
        pub const UINT32: _bindgen_ty_74 = sensor_msgs__msg__PointField__UINT32;
        pub const UINT8: _bindgen_ty_70 = sensor_msgs__msg__PointField__UINT8;
    }
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(default)]
    pub struct Range {
    ...
    #[allow(non_upper_case_globals)]
    impl Range {
        pub const INFRARED: _bindgen_ty_139 = sensor_msgs__msg__Range__INFRARED;
        pub const ULTRASOUND: _bindgen_ty_138 = sensor_msgs__msg__Range__ULTRASOUND;
    }
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(default)]
