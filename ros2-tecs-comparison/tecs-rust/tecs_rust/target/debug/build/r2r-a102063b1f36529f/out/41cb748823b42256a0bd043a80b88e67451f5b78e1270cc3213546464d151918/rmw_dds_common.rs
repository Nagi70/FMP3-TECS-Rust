pub mod msg {
    ...
    impl WrappedTypesupport for Gid {
        ...
        fn create_msg() -> *mut rmw_dds_common__msg__Gid {
            ...
            #[cfg(feature = "doc-only")] rmw_dds_common__msg__Gid__create()
        }
        fn destroy_msg(msg: *mut rmw_dds_common__msg__Gid) -> () {
            #[cfg(not(feature = "doc-only"))]
            unsafe { rmw_dds_common__msg__Gid__destroy(msg) };
            #[cfg(feature = "doc-only")] rmw_dds_common__msg__Gid__destroy(msg)
        }
        fn from_native(#[allow(unused)] msg: &Self::CStruct) -> Gid {
            Gid { data: msg.data.to_vec() }
        }
        fn copy_to_native(&self, #[allow(unused)] msg: &mut Self::CStruct) {
            ...
            msg.data.copy_from_slice(&self.data[..24usize]);
        }
    }
    ...
    impl WrappedTypesupport for NodeEntitiesInfo {
        ...
        fn create_msg() -> *mut rmw_dds_common__msg__NodeEntitiesInfo {
            ...
            #[cfg(feature = "doc-only")] rmw_dds_common__msg__NodeEntitiesInfo__create()
        }
        fn destroy_msg(msg: *mut rmw_dds_common__msg__NodeEntitiesInfo) -> () {
            ...
            rmw_dds_common__msg__NodeEntitiesInfo__destroy(msg)
        }
        fn from_native(#[allow(unused)] msg: &Self::CStruct) -> NodeEntitiesInfo {
            NodeEntitiesInfo {
                ...
                reader_gid_seq: {
                    ...
                    if msg.reader_gid_seq.data != std::ptr::null_mut() {
                        let slice = unsafe {
                            std::slice::from_raw_parts(
                                msg.reader_gid_seq.data,
                                msg.reader_gid_seq.size,
                            )
                        };
                        for s in slice {
                            temp.push(rmw_dds_common::msg::Gid::from_native(s));
                        }
                    }
                    temp
                },
                writer_gid_seq: {
                    ...
                    if msg.writer_gid_seq.data != std::ptr::null_mut() {
                        let slice = unsafe {
                            std::slice::from_raw_parts(
                                msg.writer_gid_seq.data,
                                msg.writer_gid_seq.size,
                            )
                        };
                        for s in slice {
                            temp.push(rmw_dds_common::msg::Gid::from_native(s));
        ...
        fn copy_to_native(&self, #[allow(unused)] msg: &mut Self::CStruct) {
            ...
            unsafe {
                rmw_dds_common__msg__Gid__Sequence__fini(&mut msg.reader_gid_seq);
                rmw_dds_common__msg__Gid__Sequence__init(
                    &mut msg.reader_gid_seq,
                ...
                if msg.reader_gid_seq.data != std::ptr::null_mut() {
                    ...
                    for (t, s) in slice.iter_mut().zip(&self.reader_gid_seq) {
                        s.copy_to_native(t);
                    }
                }
            }
            unsafe {
                rmw_dds_common__msg__Gid__Sequence__fini(&mut msg.writer_gid_seq);
                rmw_dds_common__msg__Gid__Sequence__init(
                    &mut msg.writer_gid_seq,
                ...
                if msg.writer_gid_seq.data != std::ptr::null_mut() {
                    ...
                    for (t, s) in slice.iter_mut().zip(&self.writer_gid_seq) {
                        s.copy_to_native(t);
                    }
                }
            }
    ...
    impl WrappedTypesupport for ParticipantEntitiesInfo {
        ...
        fn destroy_msg(msg: *mut rmw_dds_common__msg__ParticipantEntitiesInfo) -> () {
            ...
            #[cfg(feature = "doc-only")]
            rmw_dds_common__msg__ParticipantEntitiesInfo__destroy(msg)
        }
        fn from_native(#[allow(unused)] msg: &Self::CStruct) -> ParticipantEntitiesInfo {
            ParticipantEntitiesInfo {
                ...
                node_entities_info_seq: {
                    ...
                    if msg.node_entities_info_seq.data != std::ptr::null_mut() {
                        let slice = unsafe {
                            std::slice::from_raw_parts(
                                msg.node_entities_info_seq.data,
                                msg.node_entities_info_seq.size,
                            )
                        };
                        for s in slice {
                            temp.push(
                                rmw_dds_common::msg::NodeEntitiesInfo::from_native(s),
                            );
                        }
                    }
                    temp
        ...
        fn copy_to_native(&self, #[allow(unused)] msg: &mut Self::CStruct) {
            ...
            unsafe {
                ...
                if msg.node_entities_info_seq.data != std::ptr::null_mut() {
                    ...
                    for (t, s) in slice.iter_mut().zip(&self.node_entities_info_seq) {
                        s.copy_to_native(t);
                    }
                }
            }
