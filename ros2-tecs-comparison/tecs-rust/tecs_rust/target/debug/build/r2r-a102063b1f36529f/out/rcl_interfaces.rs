pub mod msg {
    ...
    impl Log {
        pub const DEBUG: _bindgen_ty_82 = rcl_interfaces__msg__Log__DEBUG;
        pub const ERROR: _bindgen_ty_85 = rcl_interfaces__msg__Log__ERROR;
        pub const FATAL: _bindgen_ty_86 = rcl_interfaces__msg__Log__FATAL;
        pub const INFO: _bindgen_ty_83 = rcl_interfaces__msg__Log__INFO;
        pub const WARN: _bindgen_ty_84 = rcl_interfaces__msg__Log__WARN;
    }
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(default)]
        ...
        fn from_native(#[allow(unused)] msg: &Self::CStruct) -> ParameterDescriptor {
            ParameterDescriptor {
                ...
                floating_point_range: {
                    ...
                    if msg.floating_point_range.data != std::ptr::null_mut() {
                        let slice = unsafe {
                ...
                integer_range: {
                    ...
                    if msg.integer_range.data != std::ptr::null_mut() {
                        let slice = unsafe {
                            std::slice::from_raw_parts(
        ...
        fn from_native(#[allow(unused)] msg: &Self::CStruct) -> ParameterEvent {
            ParameterEvent {
                ...
                new_parameters: {
                    ...
                    if msg.new_parameters.data != std::ptr::null_mut() {
                        let slice = unsafe {
                            std::slice::from_raw_parts(
                ...
                changed_parameters: {
                    ...
                    if msg.changed_parameters.data != std::ptr::null_mut() {
                        let slice = unsafe {
                            std::slice::from_raw_parts(
                ...
                deleted_parameters: {
                    ...
                    if msg.deleted_parameters.data != std::ptr::null_mut() {
                        let slice = unsafe {
                            std::slice::from_raw_parts(
    ...
    #[allow(non_upper_case_globals)]
    impl ParameterType {
        pub const PARAMETER_BOOL: _bindgen_ty_90 = rcl_interfaces__msg__ParameterType__PARAMETER_BOOL;
        pub const PARAMETER_BOOL_ARRAY: _bindgen_ty_95 = rcl_interfaces__msg__ParameterType__PARAMETER_BOOL_ARRAY;
        pub const PARAMETER_BYTE_ARRAY: _bindgen_ty_94 = rcl_interfaces__msg__ParameterType__PARAMETER_BYTE_ARRAY;
        pub const PARAMETER_DOUBLE: _bindgen_ty_92 = rcl_interfaces__msg__ParameterType__PARAMETER_DOUBLE;
        pub const PARAMETER_DOUBLE_ARRAY: _bindgen_ty_97 = rcl_interfaces__msg__ParameterType__PARAMETER_DOUBLE_ARRAY;
        pub const PARAMETER_INTEGER: _bindgen_ty_91 = rcl_interfaces__msg__ParameterType__PARAMETER_INTEGER;
        pub const PARAMETER_INTEGER_ARRAY: _bindgen_ty_96 = rcl_interfaces__msg__ParameterType__PARAMETER_INTEGER_ARRAY;
        pub const PARAMETER_NOT_SET: _bindgen_ty_89 = rcl_interfaces__msg__ParameterType__PARAMETER_NOT_SET;
        pub const PARAMETER_STRING: _bindgen_ty_93 = rcl_interfaces__msg__ParameterType__PARAMETER_STRING;
        pub const PARAMETER_STRING_ARRAY: _bindgen_ty_98 = rcl_interfaces__msg__ParameterType__PARAMETER_STRING_ARRAY;
    }
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(default)]
...
pub mod srv {
            ...
            fn from_native(#[allow(unused)] msg: &Self::CStruct) -> Response {
                Response {
                    descriptors: {
                        ...
                        if msg.descriptors.data != std::ptr::null_mut() {
                            let slice = unsafe {
                                std::slice::from_raw_parts(
            ...
            fn from_native(#[allow(unused)] msg: &Self::CStruct) -> Response {
                Response {
                    values: {
                        ...
                        if msg.values.data != std::ptr::null_mut() {
                            let slice = unsafe {
    ...
    pub mod ListParameters {
        ...
        #[allow(non_upper_case_globals)]
        impl Request {
            pub const DEPTH_RECURSIVE: _bindgen_ty_99 = rcl_interfaces__srv__ListParameters_Request__DEPTH_RECURSIVE;
        }
        #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
        #[serde(default)]
        pub struct Response {
            ...
            fn from_native(#[allow(unused)] msg: &Self::CStruct) -> Request {
                Request {
                    parameters: {
                        ...
                        if msg.parameters.data != std::ptr::null_mut() {
                            let slice = unsafe {
                                std::slice::from_raw_parts(
                                    msg.parameters.data,
                                    msg.parameters.size,
