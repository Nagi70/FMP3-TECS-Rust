...
for dir in ex*/; do
  ...
  ar="$dir/libitron.a"
  txt="$dir/size_of_libitron.txt"
  sec_csv="$dir/libitron_sections.csv"
  obj_csv="$dir/libitron_objects.csv"
...
combined_obj="$ROOT_DIR/libitron_objects_all.csv"
...
for f in ex*/libitron_objects.csv; do
